...
public class MainActivity extends AppCompatActivity
    ...
    ArrayList<HashMap<String, String>> medidaList;
        ...
        protected Void doInBackground(Void... arg0) {
            ...
            if (jsonStr != null) {
                try {
                    ...
                    String hora = null;
                    if (jsonObj != null) {
                        hora = jsonObj.getString("timestamp_minute");
                        Log.d("Hora: ",hora);
                    }else{
                        Log.d("NULO","NULO");
                    }
                    HashMap<String, String> medida = new HashMap<>();
                    medida.put("id", "Hora_id");
                    medida.put("hora",hora);
                    medidaList.add(medida);
                    Log.d("MedidaList: ",medidaList.get(0).toString());
